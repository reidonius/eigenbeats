...
(define $drums
  (class object% (super-new)
    ...
    (define/public (o-hi-hat)
      (myplay rds:o-hi-hat (now) .5))
    (define/public (c-hi-hat-1)
      (myplay rds:c-hi-hat-1 (now) .5))
    (define/public (c-hi-hat-2)
      (myplay rds:c-hi-hat-2 (now) .5))
    (define/public (clap-1)
      (myplay rds:clap-1 (now) .5))
    (define/public (clap-2)
      (myplay rds:clap-2 (now) .5))
    (define/public (crash-cymbal)
      (myplay rds:crash-cymbal (now) .5))
    (define/public (snare)
      (myplay rds:snare (now) .5))))
